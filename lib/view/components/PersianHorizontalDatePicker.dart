...
Widget buildPersianHorizontalDatePicker({
  ...
  return PersianHorizontalDatePicker(
    ...
    initialSelectedDayTextStyle: Theme.of(context).textTheme.titleLarge?.copyWith(fontSize: 13.sp,fontFamily: "IRANYekan_number"),
    initialSelectedWeekDayTextStyle:Theme.of(context).textTheme.bodyMedium?.copyWith(fontSize:10.sp),
    isPersianDate: true,
    datePickerHeight:56.r,
    ...
    selectedDayTextStyle:Theme.of(context).textTheme.titleLarge?.copyWith(fontSize: 13.sp,fontFamily: "IRANYekan_number") ,
    radius: 30,
